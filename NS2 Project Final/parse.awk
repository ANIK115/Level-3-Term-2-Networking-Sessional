...
END {
   ...
   print nodes","flows","packets_per_sec","speed"," sent_packets","dropped_packets","received_packets","throughput","average_delay","delivery_ratio","drop_ratio","average_energy;
