...
if sys.argv[1]=='nn':
    ...
    baseline_throughput = baseline_data.iloc[:5, 6].values
    baseline_delay = baseline_data.iloc[:5, 7].values
    baseline_delivery_ratio = baseline_data.iloc[:5, 8].values
    baseline_drop_ratio = baseline_data.iloc[:5, 9].values
    modified_throughput = modified_data.iloc[:5, 6].values
    modified_delay = modified_data.iloc[:5, 7].values
    modified_delivery_ratio = modified_data.iloc[:5, 8].values
    modified_drop_ratio = modified_data.iloc[:5, 9].values
elif sys.argv[1]=='nf':
