...
END {
	...
	rThroughput = (nReceivedBytes*8) / (rTime * 1024);
	...
	print nodes,",", flows,",", packets, ",", nSentPackets,",", nDropPackets,",",nReceivedPackets,",",rThroughput,",", rAverageDelay,",", rPacketDeliveryRatio, ",", rPacketDropRatio;
}
